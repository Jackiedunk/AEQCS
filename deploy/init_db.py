...
DO $$
BEGIN
  IF NOT EXISTS (SELECT FROM pg_roles WHERE rolname = 'aeqcs_core') THEN
    CREATE ROLE aeqcs_core LOGIN PASSWORD 'CHANGE_ME_AEQCS_CORE';
  END IF;
...
GRANT USAGE, CREATE ON SCHEMA public TO aeqcs_core;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO aeqcs_core;
GRANT USAGE, SELECT, UPDATE ON ALL SEQUENCES IN SCHEMA public TO aeqcs_core;
ALTER DEFAULT PRIVILEGES IN SCHEMA public
  GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO aeqcs_core;
ALTER DEFAULT PRIVILEGES IN SCHEMA public
  GRANT USAGE, SELECT, UPDATE ON SEQUENCES TO aeqcs_core;
